...
public class AddRestaurantAdapter extends RecyclerView.Adapter<AddRestaurantViewHolder> {

    private List<Restaurant> restaurants = new ArrayList<>();
    private Context mContext;


    public AddRestaurantAdapter(List<Restaurant> restaurants, Context context){
    ...
    @NonNull
    @Override
    public AddRestaurantViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater
                .from(mContext)
                .inflate(R.layout.item_row_restaurant, viewGroup, false);
        return new AddRestaurantViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull AddRestaurantViewHolder restaurantViewHolder, int position) {
        ...
        restaurantViewHolder.setItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, boolean isLongClick) {
                if(isLongClick){
                    ...
                    Intent i = new Intent(mContext,AddRestaurantPage.class);
...
class AddRestaurantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {
    private List<Restaurant> restaurants = new ArrayList<>();
    ...
    AddRestaurantViewHolder(@NonNull View itemView) {
        super(itemView);
