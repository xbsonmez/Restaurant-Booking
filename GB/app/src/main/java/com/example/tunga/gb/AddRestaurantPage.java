...
public class AddRestaurantPage extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getSupportActionBar().setTitle("Add Restaurant Page");

        final Intent intent = getIntent();
        int RestaurantId = intent.getIntExtra("RestaurantId", 0);


        editRestaurant = (Button) findViewById(R.id.add_restaurant_page_edit_profile_button);
        deleteRestaurant = (Button) findViewById(R.id.add_restaurant_page_delete_restaurant_button);
        textView = (TextView) findViewById(R.id.add_restaurant_page_rest_name_tw);
        textView1 = (TextView) findViewById(R.id.add_restaurant_page_rest_address_tw);
        textView2 = (TextView) findViewById(R.id.add_restaurant_page_rest_phone_tw);
        textView3 = (TextView) findViewById(R.id.add_restaurant_page_rest_features_tw);
        makeReservation = (Button) findViewById(R.id.add_make_reservation_button);
        showReservationList = (Button) findViewById(R.id.add_show_reservation_list_button);
        approveButton = (Button) findViewById(R.id.add_approve_button_for_admin);
        rejectButton=(Button) findViewById(R.id.add_reject_button_for_admin);
