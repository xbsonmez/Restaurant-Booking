...
public class UpdateRestaurantAdapter extends RecyclerView.Adapter<UpdateRestaurantViewHolder> {

    private List<Restaurant> restaurants = new ArrayList<>();
    private Context mContext;


    public UpdateRestaurantAdapter(List<Restaurant> restaurants, Context context){
    ...
    @NonNull
    @Override
    public UpdateRestaurantViewHolder onCreateViewHolder(@NonNull ViewGroup viewGroup, int i) {
        View view = LayoutInflater
                .from(mContext)
                .inflate(R.layout.item_row_restaurant, viewGroup, false);
        return new UpdateRestaurantViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull UpdateRestaurantViewHolder restaurantViewHolder, int position) {
        ...
        restaurantViewHolder.setItemClickListener(new OnItemClickListener() {
            ...
            public void onItemClick(View view, int position, boolean isLongClick) {
                if(isLongClick){
                    ...
                    Intent i = new Intent(mContext,UpdateRestaurantPage.class);
...
class UpdateRestaurantViewHolder extends RecyclerView.ViewHolder implements View.OnClickListener,View.OnLongClickListener {
    private List<Restaurant> restaurants = new ArrayList<>();
    ...
    UpdateRestaurantViewHolder(@NonNull View itemView) {
        super(itemView);
